...
namespace AlbinMicroService.MasterData.Domain.ContextDb
{
    ...
    public partial class MasterDataDbContext(DbContextOptions<MasterDataDbContext> options) : DbContext(options)
    {
    ...
    /// <summary>
    /// MasterDataDbContext Custom Configurations
    /// </summary>
    public partial class MasterDataDbContext
    {
        static partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
        {
            // Apply global IsDeleted filter
